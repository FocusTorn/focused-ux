...
const ASSETS_DIR_ABS = path.join(SOURCE_ROOT, 'assets')
...
export async function main( //>
	...
	console.log(`  Source: ${SOURCE_ICONS_DIR_ABS}`)
	console.log(`  Output: ${ASSETS_DIR_ABS}`)
	console.log(
...
if (process.argv[1] && process.argv[1].endsWith('generate_optimized_icons.ts')) {
