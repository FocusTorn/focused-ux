...
describe('ConfigLoader', () => {
    ...
    describe('file system errors', () => {
        ...
        it('should handle directory instead of file', async () => {
            ...
            const _scenario = createPaeMockBuilder(mocks)
                .configLoaderError({
                    ...
                    errorMessage:
                        'Failed to load config from /path/to/directory: EISDIR: illegal operation on a directory',
                })
                .build()
            ...
            await expect(configLoader.loadConfig()).rejects.toThrow('Failed to load config from')
        ...
        it('should handle permission denied errors', async () => {
            ...
            const _scenario = createPaeMockBuilder(mocks)
                .configLoaderError({
                    ...
                    errorMessage:
                        'Failed to load config from /path/to/file: EACCES: permission denied',
                })
                .build()
        ...
        it('should handle file locked errors', async () => {
            ...
            const _scenario = createPaeMockBuilder(mocks)
                .configLoaderError({
                    ...
                    errorMessage:
                        'Failed to load config from /path/to/file: EBUSY: resource busy or locked',
                })
                .build()
        ...
        it('should handle file deletion gracefully', async () => {
            ...
            configLoader.loadConfig.mockResolvedValueOnce(config).mockRejectedValueOnce(error)
        ...
        it('should handle config file being deleted during load', async () => {
            ...
            const error = new Error(
                'Failed to load config from /path/to/file: ENOENT: no such file or directory'
            )
            configLoader.loadConfig.mockRejectedValue(error)
    ...
    describe('YAML parsing errors', () => {
        ...
        it('should throw error for invalid YAML', async () => {
            ...
            const _scenario = createPaeMockBuilder(mocks)
                .configLoaderError({
                    ...
                    errorMessage:
                        'Failed to parse YAML config from /path/to/file: invalid: yaml: content: [',
                })
                .build()
        ...
        it('should handle malformed YAML', async () => {
            ...
            const error = new Error(
                'Failed to parse YAML config from /path/to/file: nxPackages:\n  test-package: [unclosed array'
            )
            configLoader.loadConfig.mockRejectedValue(error)
        ...
        it('should handle non-YAML content', async () => {
            ...
            const error = new Error(
                'Failed to parse YAML config from /path/to/file: This is not YAML content at all'
            )
            configLoader.loadConfig.mockRejectedValue(error)
        ...
        it('should throw error for unsupported file format', async () => {
            ...
            const error = new Error(
                'Unsupported config file format: /path/to/.pae.json. Only YAML files are supported.'
            )
            configLoader.loadConfig.mockRejectedValue(error)
        ...
        it('should handle circular references in YAML', async () => {
            ...
            const error = new Error(
                'Failed to parse YAML config from /path/to/file: nxPackages: &ref\n  test-package: test-package\ncircular: *ref'
            )
            configLoader.loadConfig.mockRejectedValue(error)
        ...
        it('should handle invalid section types', async () => {
            ...
            const _scenario = createPaeMockBuilder(mocks)
                .configLoaderError({
                    errorType: 'validation-error',
                    errorMessage:
                        'Configuration validation failed: expandable-flags must be an object',
                })
                .build()
