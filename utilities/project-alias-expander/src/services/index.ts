// PAE Services - Centralized exports following architecture patterns
export { ExpandableProcessorService, expandableProcessor } from './ExpandableProcessor.service.js'
