...
describe('WorkspaceAdapter', () => {
	it('delegates to vscode.workspace APIs', async () => {
		...
		const { WorkspaceAdapter } = await import('../vscode/adapters/Workspace.adapter.js')
		const { TextDocumentAdapter } = await import('../vscode/adapters/TextDocument.adapter.js')
