...
function showHelp() {
	...
	console.log('  • Ext packages require full target set (lint, lint:deps, check-types, check-types:full, validate, validate:deps)')
	...
	console.log('  • Only require lint, lint:deps, check-types, and check-types:full targets')
